...
class VersesModel with _$VersesModel {
  ...
  factory VersesModel.fromJson(Map<String, dynamic> json) => _$VersesModelFromJson(json);
...
@freezed
class VersesNumberModel with _$VersesNumberModel {
  ...
  factory VersesNumberModel.fromJson(Map<String, dynamic> json) => _$VersesNumberModelFromJson(json);

  factory VersesNumberModel.fromEntity(VersesNumber entity) => VersesNumberModel(
...
@freezed
class VersesMetaModel with _$VersesMetaModel {
  ...
  factory VersesMetaModel.fromJson(Map<String, dynamic> json) => _$VersesMetaModelFromJson(json);
...
@freezed
class VersesSajdaModel with _$VersesSajdaModel {
  ...
  factory VersesSajdaModel.fromJson(Map<String, dynamic> json) => _$VersesSajdaModelFromJson(json);
...
@freezed
class VersesTextModel with _$VersesTextModel {
  ...
  factory VersesTextModel.fromJson(Map<String, dynamic> json) => _$VersesTextModelFromJson(json);
...
@freezed
class VersesTafsirModel with _$VersesTafsirModel {
  const factory VersesTafsirModel({
    TypeVersesTafsirModel? id,
  }) = _VersesTafsirModel;

  const VersesTafsirModel._();
  factory VersesTafsirModel.fromJson(Map<String, dynamic> json) => _$VersesTafsirModelFromJson(json);

  factory VersesTafsirModel.fromEntity(VersesTafsir entity) => VersesTafsirModel(
...
@freezed
class TypeVersesTafsirModel with _$TypeVersesTafsirModel {
  ...
  factory TypeVersesTafsirModel.fromJson(Map<String, dynamic> json) => _$TypeVersesTafsirModelFromJson(json);

  factory TypeVersesTafsirModel.fromEntity(TypeVersesTafsir entity) => TypeVersesTafsirModel(
    short: entity.short,
    long: entity.long,
  );
